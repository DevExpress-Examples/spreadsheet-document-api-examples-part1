...
'#Region "Actions"
        Public ApplayStyleAction As Action(Of Workbook) = AddressOf ApplayStyle
...
'#End Region
        Private Sub ApplayStyle(ByVal workbook As Workbook)
...
'#Region "#AlignCellContents"
            ...
            cellB2.Alignment.Horizontal = HorizontalAlignment.Center
