...
Namespace SpreadsheetExamples
    Public NotInheritable Class FormulaActions
        ...
        #Region "Actions"
        Public Shared UseConstantsAndCalculationOperatorsInFormulasAction As Action(Of Workbook) = AddressOf UseConstantsAndCalculationOperatorsInFormulas
        Public Shared R1C1ReferencesInFormulassAction As Action(Of Workbook) = AddressOf R1C1ReferencesInFormulas
        Public Shared UseNamesInFormulasAction As Action(Of Workbook) = AddressOf UseNamesInFormulas
        Public Shared CreateNamedFormulasAction As Action(Of Workbook) = AddressOf CreateNamedFormulas
        Public Shared UseFunctionsInFormulasAction As Action(Of Workbook) = AddressOf UseFunctionsInFormulas
        Public Shared CreateSharedAndArrayFormulasAction As Action(Of Workbook) = AddressOf CreateSharedAndArrayFormulas
        #End Region

        Private Shared Sub UseConstantsAndCalculationOperatorsInFormulas(ByVal workbook As Workbook)
...
'            #End Region ' #ConstantsAndCalculationOperators
        ...
        Private Shared Sub R1C1ReferencesInFormulas(ByVal workbook As Workbook)
            Dim worksheet As Worksheet = workbook.Worksheets(0)
...
'            #End Region ' #NamesInFormulas
        ...
        Private Shared Sub CreateNamedFormulas(ByVal workbook As Workbook)
...
'            #End Region ' #NamedFormulas
        ...
        Private Shared Sub UseFunctionsInFormulas(ByVal workbook As Workbook)
            Dim worksheet As Worksheet = workbook.Worksheets(0)
            ' Provide static data.
            worksheet.Cells("A1").Value = "Data"
...
'            #End Region ' #FunctionsInFormulas
        ...
        Private Shared Sub CreateSharedAndArrayFormulas(ByVal workbook As Workbook)
            Dim worksheet As Worksheet = workbook.Worksheets(0)
