...
namespace SpreadsheetExamples {
    public static class RowAndColumnActions {
        ...
        public static Action<Workbook> DeleteRowsBasedOnConditionAction = DeleteRowsBasedOnCondition;
        public static Action<Workbook> DeleteColumnsBasedOnConditionAction = DeleteColumnsBasedOnCondition;
